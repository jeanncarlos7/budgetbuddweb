...
export default function Home() {
  ...
  const ultimasMovimentacoes = [
    {
      id: 1,
      data: "19/04/2024", // 19 de abril de 2024
    ...
    {
      id: 2,
      data: "18/04/2024", // 18 de abril de 2024
    ...
    {
      id: 3,
      data: "17/04/2024", // 17 de abril de 2024
    ...
    {
      id: 4,
      data: "16/04/2024", // 16 de abril de 2024
    ...
    {
      id: 5,
      data: "15/04/2024", // 15 de abril de 2024
      descricao: "Venda de livro",
      valor: 20.00,
      tipo: "ENTRADA",
      categoria: {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-4">
      ...
      <section className="grid grid-flow-col-dense gap-5">
        {totais.map(t => <CardStats key={t.title} {...t} />)}
      </section>
